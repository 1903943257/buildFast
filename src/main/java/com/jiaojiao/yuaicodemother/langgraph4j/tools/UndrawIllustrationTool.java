package com.jiaojiao.yuaicodemother.langgraph4j.tools;
...
import com.jiaojiao.yuaicodemother.langgraph4j.enums.ImageCategoryEnum;
...
public class UndrawIllustrationTool {
    ...
    private static final String UNDRAW_API_URL = "https://undraw.co/_next/data/_FTM2d-THILOVilGvbqjc/illustrations.json?term=happy";
    ...
    public List<ImageResource> searchIllustrations(@P("搜索关键词") String query) {
        ...
        try (HttpResponse response = HttpRequest.get(apiUrl).timeout(10000).execute()) {
            ...
            JSONArray initialResults = pageProps.getJSONArray("illustrations");
