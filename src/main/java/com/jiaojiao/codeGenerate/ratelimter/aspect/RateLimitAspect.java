package com.jiaojiao.codeGenerate.ratelimter.aspect;
...
public class RateLimitAspect {
    ...
    public void deBefore(JoinPoint point, RateLimit rateLimit){
        String key = generateRateLimitKey(point, rateLimit);
        RRateLimiter rateLimiter = redissonClient.getRateLimiter(key);
        rateLimiter.expire(Duration.ofHours(1)); // 过期时间1小时
